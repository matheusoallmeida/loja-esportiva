        ...
        <div class="container">
            @if(auth()->user()->role === 'admin')
                <div class="admin-hero dashboard-hero mb-4">
                    ...
                    <a href="{{ route('admin.configuracoes') }}" class="btn btn-light fw-bold">Configurar APIs</a>
                </div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6 col-xl-3">
                        <a href="{{ route('admin.configuracoes') }}" class="admin-action d-block text-decoration-none h-100">
                            <span>04</span>
            ...
            @else
                <div class="row g-4">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <a href="{{ route('cliente.compras') }}" class="admin-card border rounded p-4 h-100 d-block text-decoration-none text-dark">
                            <p class="text-secondary small text-uppercase fw-bold letter-spaced mb-2">Cliente</p>
                            <h2 class="h4 fw-black">Minhas compras</h2>
                            <p class="text-secondary mb-0">Acompanhe compras, pagamento e entrega.</p>
                        </a>
                    </div>
                </div>
