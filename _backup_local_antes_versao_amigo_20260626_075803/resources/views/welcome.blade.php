    ...
    <section id="produtos" class="store-section bg-white py-4 py-lg-5">
        <div class="container-fluid px-4 px-lg-5">
            <div class="d-flex align-items-center justify-content-between mb-4">
                <h2 class="section-title mb-0">{{ $categoriaAtual || $mostrarTodos ? 'PRODUTOS' : 'DESTAQUES' }}</h2>
                @if($mostrarTodos)
                    <a href="{{ url('/#produtos') }}" class="view-all-link">Ver menos -></a>
                @else
                    <a href="{{ url('/?todos=1#produtos') }}" class="view-all-link">Ver tudo -></a>
                @endif
            </div>
